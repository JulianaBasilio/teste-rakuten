...
$(document).ready(function(){$(".color-carousel").slick({arrows:!0,slidesToShow:4,slidesToScroll:1,focusOnSelect:!0}),$(".product-carousel").slick({arrows:!0,slidesToShow:5}),$(".instagram-carousel").slick({arrows:!0,slidesToShow:4}),$(".gallery-carousel-main").slick({slidesToShow:1,slidesToScroll:1,arrows:!1,fade:!0,draggable:!1,focusOnSelect:!1}),$(".gallery-carousel-nav").slick({slidesToShow:6,asNavFor:".gallery-carousel-main",dots:!1,focusOnSelect:!0,vertical:!0})});